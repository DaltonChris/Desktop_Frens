...
namespace Desktop_Frens
{
    public partial class MainWindow : Window
    {
        ...
        {
            _Slug_Fren = new(FrenID.Slug, 6, this, 3.95, 95, this._AnimatedImg_1, 60, 60, -1); // -1
            _Dog_Fren = new(FrenID.Dog, 7, this, 7.4, 75, _AnimatedImg_2, 85, 95, -5); // -5
            _Spooky_Fren = new(FrenID.Spooky, 8, this, 5.9, 85, _AnimatedImg_3, 110, 110, -50); // -52
            _Frog_Fren = new(FrenID.Frog, 7, this, 0.3, 135, _AnimatedImg_4, 75, 100, 10); //10  move-1.3
            _Frog_B_Fren = new(FrenID.Frog_B, 7, this, 0.3, 135, _AnimatedImg_5, 95, 115, -5); // -5 move-2
        }
