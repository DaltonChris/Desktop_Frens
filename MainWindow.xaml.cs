...
namespace Desktop_Frens
{
    public partial class MainWindow : Window
    {
        ...
        {
            _Slug_Fren = new("Slug", 6 , this,3.95, 88, this._AnimatedImg_1,60,60,40); // -1
            ...
            _Frog_Fren = new("Frog", 7 , this,0.3, 135, _AnimatedImg_4, 75, 100, 48); //10  move-1.3
            _Frog_B_Fren = new("Frog_B", 7, this, 0.3, 135, _AnimatedImg_5, 95, 115, 35); // -5 move-2
        }
